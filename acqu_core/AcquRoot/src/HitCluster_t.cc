...
Bool_t HitCluster_t::SetFields(const std::vector< crystal_t >& cluster, // hit indices in cluster
    Double_t Energy,                    // Total energy deposited in cluster
    Double_t CentralFrac,               // Fractional energy in central crystal
    Double_t Time,                      // Time of max-energy element of cluster
